...
% plot_mean_kds_02.m - 20190121 - patched more, so that many datasets can
% be visualized
...
if any(strcmp(d.rna,'R02'))
    n_entries_to_change = sum(strcmp(d.rna,'R02'));
    d(strcmp(d.rna,'R02'),'rna') = dataset({repmat({'RNA0'},n_entries_to_change,1), 'rna'});
end;
