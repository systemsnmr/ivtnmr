...
% TODO
% v04 (changes input args - version up)
...
function o = fit_Kd_03(ligand_conc, target_csp, target_conc, plot_results, fix_dsat)
...
%=================================================
if plot_results
    sbSide = 220; sbWidth = sbSide; sbHeight = sbSide*1.4; fSize = 12;
...
%         title_string = sprintf('%s\nKd = %.0f uM', fit_name, popt(2));
        ...
        if pk==1
            xlab_string = {'RNA [uM]', '(from 31P integrals per reaction time)'};
