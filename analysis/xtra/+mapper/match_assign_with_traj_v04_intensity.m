function assign = match_assign_with_traj_v04_intensity(dset_name, peaklist_filepath, traj_filepath, prot_seq_filepath)

% Versions:
% match_assign_with_traj.m - initial
% match_assign_with_traj_v02.m:
%   - imports protein sequence, adds to "assign" structure
%   - saves trajectories too (not just traj_ids):
%       traj_H, traj_N, traj_Hdelta, traj_Ndelta, traj_HNcsp - also
%       non-unique ones!
% match_assign_with_traj_v03_many_Pz - to run for many proteins (when
% analyzing site-mapper_v0.2

% match_assign_with_traj_v04_intensity: now includes intensity (also
% assigned by nearest-neighbor);
